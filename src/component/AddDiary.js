...
function AddDiary() {
  return <div className='add__diary'>
    <header>
      <div className='add__diary__avatar'>
        <img src='https://scontent-lga3-1.xx.fbcdn.net/v/t39.30808-1/cp0/c18.0.40.40a/p40x40/272298909_3231971627031179_6410520637699308460_n.jpg?_nc_cat=109&ccb=1-5&_nc_sid=7206a8&_nc_eui2=AeFOjL60rkOdf6BPIEsOYC3dxcLY5dLpeOnFwtjl0ul46ZBeCx0zPHg0_wfQ7JFYJsPcrPGnnL5CgXCYmDTmJhbG&_nc_ohc=p47gHMPla1MAX9J4V2o&_nc_ht=scontent-lga3-1.xx&oh=00_AT8mQ7PSnXkxoFDzDYCqO6n2vMfmugR2eZYBJ4lt7DAZ3g&oe=61FB18FE' alt='avatar'/>
      </div>
      <div className='write__something'>
        <input type='text' placeholder='Quoi de neuf, Adam ?' />
      </div>
    </header>
